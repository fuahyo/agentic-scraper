    ...
    return {
        ...
        locateElement: {
            function: async (args) => {
                ...
                await locator
                    .first()
                    .evaluate((node, id) => node.setAttribute("data-element-id", id), elementId);
                return { elementId };
            },
            name: "locateElement",
        ...
        locator_selectOption: {
            ...
            parse: (args) => {
                return zod_1.z
                    ...
                    index: zod_1.z.union([zod_1.z.number(), zod_1.z.array(zod_1.z.number())]).optional(),
                })
        ...
        getVisibleStructure: {
            function: async () => {
                const sanitizeOptions = (0, sanitizeHtml_1.getSanitizeOptions)();
        ...
        waitForContentToLoad: {
            ...
            parse: (args) => {
                return zod_1.z
                    ...
                    textMarker: zod_1.z.string().optional(),
        ...
        extractVisibleText: {
            function: async (args) => {
                let result;
                if (args.elementId) {
                    result = await getLocator(args.elementId).evaluate((node) => {
        ...
        scrollIntoElementView: {
            function: async (args) => {
                await getLocator(args.elementId).evaluate((node, behavior) => {
                    node.scrollIntoView({
        ...
        waitForNetworkIdle: {
            ...
            parse: (args) => {
                return zod_1.z
                    .object({
                    timeout: zod_1.z.number().optional(),
                    idleTime: zod_1.z.number().optional(),
                })
                    .parse(JSON.parse(args));
            },
            parameters: {
